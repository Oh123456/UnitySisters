...
namespace UnityFramework.Algorithm
{
    public static class ArrayAlgorithm
    {
        ...
        /// <returns></returns>
        public static int UpperBound<T>(this T[] array, int length, T target, IComparer<T> comparer = null)
        {
            ...
            while (low < high)
            {
                ...
                if (comparer.Compare(array[mid], target ) <= 0)
                    low = mid + 1;
                else
                    high = mid;
            }
        ...
        /// <param name="target"> 타겟 값</param>
        /// <returns></returns>
        public static int UpperBound<T>(this T[] array, T target, IComparer<T> comparer = null)
        {
            return UpperBound(array, array.Length, target, comparer);
        }
        ...
        /// <param name="target"> 타겟 값</param>
        /// <returns></returns>
        public static int LowerBound<T>(this T[] array, int length, T target, IComparer<T> comparer = null)
        {
        ...
        public static int LowerBound<T>(this T[] array, T target, IComparer<T> comparer = null)
        {
            return LowerBound(array, array.Length, target, comparer);
        }
    }
}
